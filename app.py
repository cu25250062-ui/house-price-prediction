...
if submitted:
    ...
    # NOTE: feature order below must match exactly what the model
    # was trained on. Adjust this list/order if your training
    # script used a different set of columns.
